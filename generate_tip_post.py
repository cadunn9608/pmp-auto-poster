...
char_limit = int(text_box_w / (font_size * 0.55))
wrapped_lines = textwrap.wrap(ai_tip_raw, width=char_limit)

line_height = font_size + 6
text_box_h = (len(wrapped_lines) * line_height) + 30
text_box_y = height - text_box_h - int(height * 0.04)
text_box_x = margin

# Draw semi-transparent dark background box for high readability
...
current_y = text_box_y + 15
for line in wrapped_lines:
    draw.text((text_box_x + 15, current_y), line, fill="white", font=font)
